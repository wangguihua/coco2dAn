...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _itemLbl =[[UILabel alloc]initWithFrame:CGRectMake(40, 0, 190, 40)];
        ...
        _itemLbl.textAlignment=NSTextAlignmentNatural;
        [self addSubview:_itemLbl];
        
        _itemHigtLbl =[[UILabel alloc]initWithFrame:CGRectMake(230, 0, 80, 40)];
        _itemHigtLbl.backgroundColor =[UIColor clearColor];
        _itemHigtLbl.font=kNormalTextFont;
        _itemHigtLbl.textColor=kRedTextColor;
        [self addSubview:_itemHigtLbl];
