...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        ...
        cell.headImageView.image=[UIImage imageNamed:@"6.png"];
    }
...
{
    __block SixViewController *blockSelf = self;
    
    MBRequestItem *item = [MBRequestItem itemWithMethod:@"i_loadInfo1.action" params:@{@"infoId": _itemArray[indexPath.row][@"id"],@"keyWord":@"SIX"}];
