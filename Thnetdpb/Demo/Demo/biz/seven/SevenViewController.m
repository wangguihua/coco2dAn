...
- (void)viewDidLoad
{
    ...
    UITableView*_accTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 44+130, kScreenWidth, kContentViewHeight)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        ...
        cell.headImageView.image=[UIImage imageNamed:@"7.png"];
    }
...
{
    __block SevenViewController *blockSelf = self;
    
    MBRequestItem *item = [MBRequestItem itemWithMethod:@"i_loadInfo1.action" params:@{@"infoId": _itemArray[indexPath.row][@"id"],@"keyWord":@"SEVE"}];
